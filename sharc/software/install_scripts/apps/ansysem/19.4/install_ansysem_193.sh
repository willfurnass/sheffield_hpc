...
filename=/usr/local/media/ansys/ansys/19.4/Electronics_194_linx64/install
baseurl=
...
# /usr/local/packages/apps/ansysem/19.4/binary
# the licence server is 1055@ansyslm.shef.ac.uk
# this is a binary install
#
# To integrate with Ansys 19.4 Workbench run the following:
$prefix/AnsysEM19.4/Linux64/scripts/IntegrateWithANSYS19.4.pl
