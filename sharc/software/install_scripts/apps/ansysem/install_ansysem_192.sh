...
filename=/usr/local/media/ansys/Electronics_192_LINX64/install
baseurl=
...
# /usr/local/packages/apps/ansysem/19.2/binary
# the licence server is 1055@ansyslm.shef.ac.uk
# this is a binary install
#
# To integrate with Ansys 19.2 Workbench run the following:
$prefix/AnsysEM19.2/Linux64/scripts/IntegrateWithANSYS19.2.pl
