...
filename=/usr/local/media/ansys/Electronics_180_LINX64/install
baseurl=
...
# /usr/local/packages/apps/ansysem/18.0/binary
# the licence server is 1055@ansyslm.shef.ac.uk
# this is a binary install
#
# To integrate with Ansys 18.0 Workbench run the following:
$prefix/AnsysEM18.0/Linux64/scripts/IntegrateWithANSYS18.0.pl
