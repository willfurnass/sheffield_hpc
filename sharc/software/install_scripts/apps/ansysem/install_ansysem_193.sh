...
filename=/usr/local/media/ansys/Electronics_193_LINX64/install
baseurl=
...
# /usr/local/packages/apps/ansysem/19.3/binary
# the licence server is 1055@ansyslm.shef.ac.uk
# this is a binary install
#
# To integrate with Ansys 19.3 Workbench run the following:
$prefix/AnsysEM19.3/Linux64/scripts/IntegrateWithANSYS19.3.pl
