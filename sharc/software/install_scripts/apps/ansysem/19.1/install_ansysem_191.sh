...
filename=/usr/local/media/ansys/Electronics_191_LINX64/install
baseurl=
...
# /usr/local/packages/apps/ansysem/19.1/binary
# the licence server is 1055@ansyslm.shef.ac.uk
# this is a binary install
#
# To integrate with Ansys 19.1 Workbench run the following:
$prefix/AnsysEM19.1/Linux64/scripts/IntegrateWithANSYS19.1.pl
