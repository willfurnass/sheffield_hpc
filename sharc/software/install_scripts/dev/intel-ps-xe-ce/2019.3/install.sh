#!/bin/bash
# Install 'Intel Parallel Studio XE 2019 Composer Edition' on sharc

###############
# Set variables
###############
export SHORT_VERS=2019
export VERS="${SHORT_VERS}.3"
export COMP_VERS=19.0.3  # compilers versioned differently
...
export TARBALL_FNAME="parallel_studio_xe_2019_update3_composer_edition.tgz"
...
for modfile_src in ${!modfile_dests_map[@]}; do
    ...
    chown -R ${USER}:hpc_app-admins $(dirname $modfile_dest)
done
