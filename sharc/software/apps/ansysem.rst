...
**Note:** An accelerated-graphics interactive session with X Window support (i.e. a ``qsh-vis`` interactive session on ShARC) is required to run the ``ansysedt`` executable as a GUI. 
