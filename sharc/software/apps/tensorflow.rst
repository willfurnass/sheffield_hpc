...
* Shortcut to Latest Image
    ...
    * GPU
        * ``usr/local/packages/singularity/images/tensorflow/gpu.img``
* CPU Images (`Definition repository (CPU) <https://github.com/rses-singularity/tensorflow-cpu>`_)
...
* GPU Images (`Definition repository (GPU) <https://github.com/rses-singularity/tensorflow-gpu>`_)
