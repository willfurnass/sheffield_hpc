...
Installation Notes
------------------
Qt 5.14 was installed using GCC 8.2 with the script :download:`/usr/local/packages/apps/Qt5/5.14/gcc-8.2-cmake-3.17.1/install_Qt5.sge </sharc/software/install_scripts/apps/Qt5/5.14/install_Qt5.sge>`
...
Testing
-------
Qt 5.14 was tested with the helloworld application which can be found at https://github.com/tlanc007/qt5-qml-cpp-cmake-helloworld.git


Modulefile
----------
The module file is on the system at :download:`/usr/local/modulefiles/apps/Qt5/5.14/gcc-8.2-cmake-3.17.1 </sharc/software/modulefiles/apps/Qt5/5.14/gcc-8.2-cmake-3.17.1>`.
