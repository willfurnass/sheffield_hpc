...
filename=/usr/local/media/protected/turbomole/turbolinux721.tar.gz
...
tar -xvf $filename
cd TURBOMOLE
#Copy license file to TURBOMOLE dir.
cp $filename2 .
...
chgrp -R turbomole /usr/local/packages/apps/turbomole/$version
