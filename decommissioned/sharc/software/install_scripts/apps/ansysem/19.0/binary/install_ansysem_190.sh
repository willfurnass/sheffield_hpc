...
filename=/usr/local/media/ansys/Electronics_190_LINX64/install
baseurl=
...
# /usr/local/packages/apps/ansysem/19.0/binary
# the licence server is 1055@ansyslm.shef.ac.uk
# this is a binary install
#
# To integrate with Ansys 19.0 Workbench run the following:
$prefix/AnsysEM19.0/Linux64/scripts/IntegrateWithANSYS19.0.pl
