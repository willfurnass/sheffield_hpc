...
#Script written by JMoore 09-07-2021 @ The University of Sheffield IT Services.
...
PACKAGENAME=expat
PACKAGEVER=2.2.7
P_VER_UNDERSCORE=$(echo ${PACKAGEVER} | tr '.' '_')
GCCVER=8.2

FILENAME=$PACKAGENAME-$PACKAGEVER.tar.gz
URL="https://github.com/lib${PACKAGENAME}/lib${PACKAGENAME}/releases/download/R_${P_VER_UNDERSCORE}/${FILENAME}"
...
INSTALLDIR=/usr/local/packages/libs/$PACKAGENAME/$PACKAGEVER/gcc-$GCCVER/
