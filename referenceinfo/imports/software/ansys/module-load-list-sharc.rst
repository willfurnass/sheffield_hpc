...
After connecting to ShARC (see :ref:`ssh`),  you can start an interactive graphical session 
or submit a batch job using ANSYS programs by activating them and making them available with one of the module load commands below: ::
