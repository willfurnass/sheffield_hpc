...
While using a X11 GUI forwarding supported SSH client, an interactive session can be started on Stanage as linked above. You can load an ANSYS module above and then 
