...
* `install_pgi_netcdf_4.3.3.1.sh  <https://github.com/rcgsheffield/iceberg_software/blob/master/iceberg/software/install_scripts/libs/pgi/netcdf/install_pgi_netcdf_4.3.3.1.sh>`_ Install script
