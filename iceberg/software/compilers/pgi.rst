...
Start an interctive GPU session (:ref:`GPUInteractive`) and run one of the following module commands, depending on which version of the compilers you wish to use ::
